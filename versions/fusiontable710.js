...
//need to switch to key up later..
  ...
  function addLegend(map) {
      ...
      map.controls[google.maps.ControlPosition.RIGHT_BOTTOM].push(
          legendWrapper);
	  var tableSelection =  "CB_Boundary";
      legendContent(legendWrapper, tableSelection);
  }

  // Generate the content for the legend
  function updateLegend(tableSelection){
  ...
  // Generate the content for the legend
  function legendContent(legendWrapper, tableSelection){
	  ...
	  layerList.push("<h4>Visible Map Layers</h4>");
		...
		if (document.getElementById("PopulationCheckbox").checked == true)       {
				layerList.push("<p>Total Population</p>");          			 }
		...
		if (document.getElementById("EducationCheckbox").checked == true)        {
				layerList.push("<p>Bachelors Degree or Higher</p>");             }			
		...
		if (document.getElementById("ProjectsCheckbox").checked == true)        {
				layerList.push("<p>Emerging Projects</p>");             }	
		...
		if (document.getElementById("IncomeCheckbox").checked == true)        {
				layerList.push("<p>Median Household Income</p>");             }	
		...
		if (document.getElementById("SmallBizCheckbox").checked == true)        {
				layerList.push("<p>Small Businesses - Manufacturing</p>");             }			
...
//**Toggle Function for the checkbox**///
  function ToggleLayer(tableSelection){
		var legendWrapper = document.getElementById("legendWrapper");
        updateLegend(legendWrapper, tableSelection);
